...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={ref} className='bg-white'>
        ...
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
          {skills.map((skill, index) => (
            <div key={skill} className="p-2 sm:w-1/2 w-full">
              <div className={`bg-black rounded flex p-4 h-full items-center border-orange-400 ${inView ? `animate-slidein300 opacity-0` : 'opacity-0'}`}>
