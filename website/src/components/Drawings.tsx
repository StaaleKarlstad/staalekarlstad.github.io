      ...
      <div className="container px-5 py-10 mx-auto lg:px-40">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="text-center lg:text-left mb-20 lg:mb-0 py-24">
            <h1 className={`sm:text-4xl text-3xl font-extrabold title-font text-white mb-4 ${inView? 'animate-slidein100 opacity-0' : 'opacity-0'}`}>
              Drawing
            </h1>
            <br></br>
            <p className={`text-2xl leading-relaxed lg:w-full mx-auto lg:mx-0 italic ${inView? 'animate-slidein100 opacity-0' : 'opacity-0'}`}>
              “I sometimes think there is nothing so delightful as drawing.” <br></br><b>Vincent van Gogh</b>
            </p>
            <br></br>
            <br></br>
            <br></br>
            <p className={`text-2xl leading-relaxed lg:w-full mx-auto lg:mx-0 ${inView? 'animate-slidein300 opacity-0' : 'opacity-0'}`}>
          ...
          <div className="flex flex-col space-y-4 py-20">
            {drawings.map((drawing) => (
              <div key={drawing} className={`relative cursor-pointer ${inView? 'animate-slidein300 opacity-0' : 'opacity-0'}`} 
