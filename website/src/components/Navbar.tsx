...
export default function Navbar() {
  return (
    <header className="bg-amber-700 md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700 flex flex-wrap items-center text-base justify-center">
          <a href="#projects" className="text-white mr-5 hover:text-cyan-200">
            Projects
          </a>
          <a href="#skills" className="text-white mr-5 hover:text-cyan-200">
            Skills
          </a>
          <a href="#drawings" className="text-white mr-5 hover:text-cyan-200">
            Drawings
          </a>
          <a href="#skills" className="text-white mr-5 hover:text-cyan-200">
            Music
          </a>
          <a href="#contact" className="text-white mr-5 hover:text-cyan-200">
            Contact
          </a>
        </nav>
